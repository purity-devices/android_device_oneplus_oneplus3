...
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom androidboot.selinux=enforcing ehci-hcd.park=3 lpm_levels.sleep_disabled=1 cma=32M@0-0xffffffff androidboot.bootdevice=624000.ufshc
...
TARGET_KERNEL_CONFIG := purity_oneplus3_defconfig
